            ...
            <div className="language-slider-wrapper">
                ...
                >
                    {[...languages, ...languages].map((lang, index) => (
                        <span key={index} className="slider-item">{lang}</span>
                    ))}
                </motion.div>
            </div>
        </section>
